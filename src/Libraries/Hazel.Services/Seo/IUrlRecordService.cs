...
namespace Hazel.Services.Seo
{
    ...
    public partial interface IUrlRecordService
    {
        ...
        void SaveSlug<TEntity>(TEntity entity, string slug, int languageId) where TEntity : BaseEntity, ISlugSupported;
        ...
        string GetSeName<TEntity>(TEntity entity, int? languageId = null, bool returnDefaultValue = true,
        ...
        string ValidateSeName<TEntity>(TEntity entity, string seName, string name, bool ensureNotEmpty) where TEntity : BaseEntity, ISlugSupported;
