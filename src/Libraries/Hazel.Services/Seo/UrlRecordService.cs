...
namespace Hazel.Services.Seo
{
    ...
    public partial class UrlRecordService : IUrlRecordService
    {
        ...
        /// <summary>
        /// Defines the _seoCharacterTable.
        /// </summary>
        ...
        /// <summary>
        /// Defines the _urlRecordRepository.
        /// </summary>
        ...
        /// <summary>
        /// Defines the _seoSettings.
        /// </summary>
        private readonly SeoSettings _seoSettings;

        /// <summary>
        /// Initializes a new instance of the <see cref="UrlRecordService"/> class.
        /// </summary>
        /// <param name="languageService">The languageService<see cref="ILanguageService"/>.</param>
        /// <param name="urlRecordRepository">The urlRecordRepository<see cref="IRepository{UrlRecord}"/>.</param>
        ...
        /// <param name="seoSettings">The seoSettings<see cref="SeoSettings"/>.</param>
        ...
        {
            //cache
            return _cacheManager.Get(HazelSeoDefaults.UrlRecordAllCacheKey, () =>
            {
        ...
        protected virtual void InitializeSeoCharacterTable()
        {
            lock (_lock)
            {
                _seoCharacterTable = new Dictionary<string, string>
                {
                    ...
                    { ToUnichar("0162"), "T" }, // LATIN CAPITAL LETTER TEntity WITH CEDILLA
                    { ToUnichar("0163"), "t" }, // LATIN SMALL LETTER TEntity WITH CEDILLA
                    { ToUnichar("0164"), "T" }, // LATIN CAPITAL LETTER TEntity WITH CARON
                    { ToUnichar("0165"), "t" }, // LATIN SMALL LETTER TEntity WITH CARON
                    { ToUnichar("0166"), "T" }, // LATIN CAPITAL LETTER TEntity WITH STROKE -- no decomposition
                    { ToUnichar("0167"), "t" }, // LATIN SMALL LETTER TEntity WITH STROKE -- no decomposition
                    ...
                    { ToUnichar("01AB"), "t" }, // LATIN SMALL LETTER TEntity WITH PALATAL HOOK -- no decomposition
                    { ToUnichar("01AC"), "T" }, // LATIN CAPITAL LETTER TEntity WITH HOOK -- no decomposition
                    { ToUnichar("01AD"), "t" }, // LATIN SMALL LETTER TEntity WITH HOOK -- no decomposition
                    { ToUnichar("01AE"), "T" }, // LATIN CAPITAL LETTER TEntity WITH RETROFLEX HOOK -- no decomposition
                    ...
                    { ToUnichar("021A"), "T" }, // LATIN CAPITAL LETTER TEntity WITH COMMA BELOW
                    { ToUnichar("021B"), "t" }, // LATIN SMALL LETTER TEntity WITH COMMA BELOW
                    ...
                    { ToUnichar("0236"), "t" }, // LATIN SMALL LETTER TEntity WITH CURL -- no decomposition
                    ...
                    { ToUnichar("0287"), "y" }, // LATIN SMALL LETTER TURNED TEntity -- no decomposition
                    { ToUnichar("0288"), "t" }, // LATIN SMALL LETTER TEntity WITH RETROFLEX HOOK -- no decomposition
                    ...
                    { ToUnichar("1D1B"), "T" }, // LATIN LETTER SMALL CAPITAL TEntity -- no decomposition
                    ...
                    { ToUnichar("1E6A"), "T" }, // LATIN CAPITAL LETTER TEntity WITH DOT ABOVE
                    { ToUnichar("1E6B"), "t" }, // LATIN SMALL LETTER TEntity WITH DOT ABOVE
                    { ToUnichar("1E6C"), "T" }, // LATIN CAPITAL LETTER TEntity WITH DOT BELOW
                    { ToUnichar("1E6D"), "t" }, // LATIN SMALL LETTER TEntity WITH DOT BELOW
                    { ToUnichar("1E6E"), "T" }, // LATIN CAPITAL LETTER TEntity WITH LINE BELOW
                    { ToUnichar("1E6F"), "t" }, // LATIN SMALL LETTER TEntity WITH LINE BELOW
                    { ToUnichar("1E70"), "T" }, // LATIN CAPITAL LETTER TEntity WITH CIRCUMFLEX BELOW
                    { ToUnichar("1E71"), "t" }, // LATIN SMALL LETTER TEntity WITH CIRCUMFLEX BELOW
                    ...
                    { ToUnichar("1E97"), "t" }, // LATIN SMALL LETTER TEntity WITH DIAERESIS
        ...
        public virtual void DeleteUrlRecord(UrlRecord urlRecord)
        {
            ...
            //cache
            _cacheManager.RemoveByPrefix(HazelSeoDefaults.UrlRecordPrefixCacheKey);
        }
        ...
        public virtual UrlRecordForCaching GetBySlugCached(string slug)
        {
            ...
            //gradual loading
            var key = string.Format(HazelSeoDefaults.UrlRecordBySlugCacheKey, slug);
        ...
        public virtual string GetActiveSlug(int entityId, string entityName, int languageId)
        {
            if (_localizationSettings.LoadAllUrlRecordsOnStartup)
            {
                var key = string.Format(HazelSeoDefaults.UrlRecordActiveByIdNameLanguageCacheKey, entityId, entityName, languageId);
                return _cacheManager.Get(key, () =>
                {
                    //load all records (we know they are cached)
                    var source = GetAllUrlRecordsCached();
        ...
        public virtual void SaveSlug<TEntity>(TEntity entity, string slug, int languageId) where TEntity : BaseEntity, ISlugSupported
        {
            if (entity == null)
        ...
        public virtual string GetSeName<TEntity>(TEntity entity, int? languageId = null, bool returnDefaultValue = true,
            bool ensureTwoPublishedLanguages = true) where TEntity : BaseEntity, ISlugSupported
        {
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));
        ...
        public virtual string ValidateSeName<TEntity>(TEntity entity, string seName, string name, bool ensureNotEmpty) where TEntity : BaseEntity, ISlugSupported
        {
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));
        ...
        public virtual string ValidateSeName(int entityId, string entityName, string seName, string name, bool ensureNotEmpty)
        {
            ...
            //max length
            seName = CommonHelper.EnsureMaximumLength(seName, HazelSeoDefaults.SearchEngineNameLength);
