...
namespace Hazel.Services
{
    ...
    public static class Extensions
    {
        ...
        /// <returns>SelectList.</returns>
        public static SelectList ToSelectList<TEntity>(this TEntity objList, Func<BaseEntity, string> selector) where TEntity : IEnumerable<BaseEntity>
        {
