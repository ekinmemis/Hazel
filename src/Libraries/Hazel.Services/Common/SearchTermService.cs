...
namespace Hazel.Services.Common
{
    ...
    public partial class SearchTermService : ISearchTermService
    {
        ...
        /// <summary>
        /// Defines the _searchTermRepository.
        /// </summary>
        private readonly IRepository<SearchTerm> _searchTermRepository;

        /// <summary>
        /// Initializes a new instance of the <see cref="SearchTermService"/> class.
        /// </summary>
        /// <param name="eventPublisher">The eventPublisher<see cref="IEventPublisher"/>.</param>
        /// <param name="searchTermRepository">The searchTermRepository<see cref="IRepository{SearchTerm}"/>.</param>
