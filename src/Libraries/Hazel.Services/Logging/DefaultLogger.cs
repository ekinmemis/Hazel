...
namespace Hazel.Services.Logging
{
    ...
    public partial class DefaultLogger : ILogger
    {
        ...
        /// </summary>
        /// <param name="commonSettings">The commonSettings<see cref="CommonSettings"/>.</param>
        /// <param name="dbContext">The dbContext<see cref="IDbContext"/>.</param>
        /// <param name="logRepository">The logRepository<see cref="IRepository{Log}"/>.</param>
        ...
        /// <param name="ApplicationUser">The ApplicationUser to associate log record with.</param>
        /// <returns>A log item.</returns>
        public virtual Log InsertLog(LogLevel logLevel, string shortMessage, string fullMessage = "", ApplicationUser ApplicationUser = null)
        {
        ...
        public virtual void Information(string message, Exception exception = null, ApplicationUser ApplicationUser = null)
        {
            ...
            if (IsEnabled(LogLevel.Information))
                InsertLog(LogLevel.Information, message, exception?.ToString() ?? string.Empty, ApplicationUser);
        }
        ...
        /// <param name="exception">Exception.</param>
        /// <param name="ApplicationUser">ApplicationUser.</param>
        public virtual void Warning(string message, Exception exception = null, ApplicationUser ApplicationUser = null)
        {
            //don't log thread abort exception
            if (exception is System.Threading.ThreadAbortException)
                return;
            ...
            if (IsEnabled(LogLevel.Warning))
                InsertLog(LogLevel.Warning, message, exception?.ToString() ?? string.Empty, ApplicationUser);
        }
        ...
        /// <param name="exception">Exception.</param>
        /// <param name="ApplicationUser">ApplicationUser.</param>
        public virtual void Error(string message, Exception exception = null, ApplicationUser ApplicationUser = null)
        {
            //don't log thread abort exception
            if (exception is System.Threading.ThreadAbortException)
                return;
            ...
            if (IsEnabled(LogLevel.Error))
                InsertLog(LogLevel.Error, message, exception?.ToString() ?? string.Empty, ApplicationUser);
        }
    }
}
