...
namespace Hazel.Core.Infrastructure
{
    ...
    /// </summary>
    public class HazelFileProvider : PhysicalFileProvider, IHazelFileProvider
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HazelFileProvider"/> class.
        /// </summary>
        /// <param name="webHostEnvironment">Hosting environment.</param>
        public HazelFileProvider(IWebHostEnvironment webHostEnvironment)
        ...
        /// <param name="topDirectoryOnly">The topDirectoryOnly<see cref="bool"/>.</param>
...
#pragma warning disable CA1416 // Validate platform compatibility
        ...
        /// <param name="lastWriteTimeUtc">The lastWriteTimeUtc<see cref="DateTime"/>.</param>
