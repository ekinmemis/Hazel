...
namespace Hazel.Core
{
    ...
    public partial class CommonHelper
    {
        ...
        public static string EnsureSubscriberEmailOrThrow(string email)
        {
            ...
            {
                throw new HazelException("Email is not valid.");
            }
        ...
        /// <returns>Result.</returns>
        public static bool ArraysEqual<TEntity>(TEntity[] a1, TEntity[] a2)
        {
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            if (pi == null)
                throw new HazelException("No property '{0}' found on the instance of type '{1}'.", propertyName, instanceType);
            if (!pi.CanWrite)
                throw new HazelException("The property '{0}' on the instance of type '{1}' does not have a setter.", propertyName, instanceType);
        ...
        /// Converts a value to a destination type.
        /// </summary>
        /// <typeparam name="TEntity">The type to convert the value to.</typeparam>
        /// <param name="value">The value to convert.</param>
        /// <returns>The converted value.</returns>
        public static TEntity To<TEntity>(object value)
        {
            //return (TEntity)Convert.ChangeType(value, typeof(TEntity), CultureInfo.InvariantCulture);
            return (TEntity)To(value, typeof(TEntity));
        }
        ...
        /// </summary>
        public static IHazelFileProvider DefaultFileProvider { get; set; }
    }
}
