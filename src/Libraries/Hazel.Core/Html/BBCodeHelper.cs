...
using Hazel.Core.Html.CodeFormatter;
using Hazel.Core.Infrastructure;
using System.Text.RegularExpressions;

namespace Hazel.Core.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceUrl)
            {
                ...
                // format the URL tags: [url=https://www.hazel.com]my site[/url]
                // becomes: <a href="https://www.hazel.com">my site</a>
                text = regexUrl1.Replace(text, $"<a href=\"$1\" rel=\"nofollow\"{(newWindow ? " target=_blank" : "")}>$2</a>");

                // format the URL tags: [url]https://www.hazel.com[/url]
                // becomes: <a href="https://www.hazel.com">https://www.hazel.com</a>
            ...
            if (replaceImg)
            {
                // format the img tags: [img]https://www.hazel.com/Content/Images/Image.jpg[/img]
                // becomes: <img src="https://www.hazel.com/Content/Images/Image.jpg">
