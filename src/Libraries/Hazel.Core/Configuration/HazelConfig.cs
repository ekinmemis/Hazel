...
namespace Hazel.Core.Configuration
{
    /// <summary>
    /// Represents startup Hazel configuration parameters.
    /// </summary>
    public partial class HazelConfig
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether UseAzureBlobStorageToStoreDataProtectionKeys
        ...
        /// <summary>
        /// Gets or sets the RedisDatabaseId
        ...
        /// <summary>
        /// Gets or sets the PluginsIgnoredDuringInstallation
        /// Gets or sets a list of plugins ignored during hazel installation.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether EncryptDataProtectionKeysWithAzureKeyVault
