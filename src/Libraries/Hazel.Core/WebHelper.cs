...
namespace Hazel.Core
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        /// </summary>
        /// <param name="hostingConfig">The hostingConfig<see cref="HostingConfig"/>.</param>
        ...
        public virtual string GetCurrentIpAddress()
        {
            ...
            try
            {
                ...
                if (_httpContextAccessor.HttpContext.Request.Headers != null)
                {
                    ...
                    var forwardedHttpHeaderKey = HazelHttpDefaults.XForwardedForHeader;
        ...
        public virtual bool IsCurrentConnectionSecured()
        {
            ...
            if (_hostingConfig.UseHttpClusterHttps)
                return _httpContextAccessor.HttpContext.Request.Headers[HazelHttpDefaults.HttpClusterHttpsHeader].ToString().Equals("on", StringComparison.OrdinalIgnoreCase);

            //use HTTP_X_FORWARDED_PROTO?
            if (_hostingConfig.UseHttpXForwardedProto)
                return _httpContextAccessor.HttpContext.Request.Headers[HazelHttpDefaults.HttpXForwardedProtoHeader].ToString().Equals("https", StringComparison.OrdinalIgnoreCase);
        ...
        public virtual TEntity QueryString<TEntity>(string name)
        {
            if (!IsRequestAvailable())
                return default;
            ...
            return CommonHelper.To<TEntity>(_httpContextAccessor.HttpContext.Request.Query[name].ToString());
        }
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContextAccessor.HttpContext.Items[HazelHttpDefaults.IsPostBeingDoneRequestItem] == null)
                    return false;

                return Convert.ToBoolean(_httpContextAccessor.HttpContext.Items[HazelHttpDefaults.IsPostBeingDoneRequestItem]);
            }

            set => _httpContextAccessor.HttpContext.Items[HazelHttpDefaults.IsPostBeingDoneRequestItem] = value;
        }

        /// <summary>
        /// Gets the CurrentRequestProtocol
