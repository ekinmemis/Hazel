...
namespace Hazel.Core.Domain.ApplicationUsers
{
    ...
    /// </summary>
    public class ApplicationUserSettings : ISettings
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the UsernameValidationRule
        /// Gets or sets a username validation rule.
        /// </summary>
        public string UsernameValidationRule { get; set; }

        /// <summary>
        /// Gets or sets the DefaultPasswordFormat
        /// Default password format for applicationUsers.
        /// </summary>
        public PasswordFormat DefaultPasswordFormat { get; set; }

        /// <summary>
        /// Gets or sets the HashedPasswordFormat
        /// Gets or sets a applicationUser password format (SHA1, MD5) when passwords are hashed (DO NOT edit in production environment).
        /// </summary>
        public string HashedPasswordFormat { get; set; }

        /// <summary>
        /// Gets or sets the PasswordMinLength
        ...
        /// <summary>
        /// Gets or sets the UnduplicatedPasswordsNumber
        /// Gets or sets a number of passwords that should not be the same as the previous one; 0 if the applicationUser can use the same password time after time.
        /// </summary>
        public int UnduplicatedPasswordsNumber { get; set; }

        /// <summary>
        /// Gets or sets the PasswordRecoveryLinkDaysValid
        /// Gets or sets a number of days for password recovery link. Set to 0 if it doesn't expire..
        /// </summary>
        public int PasswordRecoveryLinkDaysValid { get; set; }

        /// <summary>
        /// Gets or sets the PasswordLifetime
        /// Gets or sets a number of days for password expiration.
        /// </summary>
        public int PasswordLifetime { get; set; }

        /// <summary>
        /// Gets or sets the FailedPasswordAllowedAttempts
        /// Gets or sets maximum login failures to lockout account. Set 0 to disable this feature.
        /// </summary>
        public int FailedPasswordAllowedAttempts { get; set; }

        /// <summary>
        /// Gets or sets the FailedPasswordLockoutMinutes
        ...
        /// <summary>
        /// Gets or sets a value indicating whether applicationUsers are allowed to upload avatars..
        /// </summary>
        public bool AllowApplicationUsersToUploadAvatars { get; set; }

        /// <summary>
        /// Gets or sets the AvatarMaximumSizeBytes
        ...
        /// <summary>
        /// Gets or sets a value indicating whether applicationUsers location is shown.
        /// </summary>
        public bool ShowApplicationUsersLocation { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether to show applicationUsers join date.
        /// </summary>
        public bool ShowApplicationUsersJoinDate { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether applicationUsers are allowed to view profiles of other applicationUsers.
        /// </summary>
        public bool AllowViewingProfiles { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether 'New applicationUser' notification message should be sent to a store owner.
        /// </summary>
        public bool NotifyNewApplicationUserRegistration { get; set; }
        ...
        /// <summary>
        /// Gets or sets the ApplicationUserNameFormat
        /// ApplicationUser name formatting.
        /// </summary>
        public ApplicationUserNameFormat ApplicationUserNameFormat { get; set; }
        ...
        /// <summary>
        /// Gets or sets the OnlineApplicationUserMinutes
        /// Gets or sets a value indicating the number of minutes for 'online applicationUsers' module.
        /// </summary>
        public int OnlineApplicationUserMinutes { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether StoreLastVisitedPage
        /// Gets or sets a value indicating we should store last visited page URL for each applicationUser.
        /// </summary>
        public bool StoreLastVisitedPage { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether StoreIpAddresses
        /// Gets or sets a value indicating we should store IP addresses of applicationUsers.
        /// </summary>
        public bool StoreIpAddresses { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether deleted applicationUser records should be prefixed suffixed with "-DELETED".
        /// </summary>
        ...
        /// </summary>
        public bool AllowApplicationUsersToCheckGiftCardBalance { get; set; }

        /// <summary>
        /// Gets or sets the DeleteGuestTaskOlderThanMinutes
        ...
        /// <summary>
        /// Gets or sets the DateOfBirthMinimumAge
