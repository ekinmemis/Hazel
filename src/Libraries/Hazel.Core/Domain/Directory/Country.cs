...
namespace Hazel.Core.Domain.Directory
{
    ...
    public partial class Country : BaseEntity, ILocalizedEntity
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether applicationUsers in this country must be charged EU VAT.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the StateProvinces.
        /// </summary>
        public virtual ICollection<StateProvince> StateProvinces { get => _stateProvinces ?? (_stateProvinces = new List<StateProvince>()); protected set => _stateProvinces = value; }
    }
}
