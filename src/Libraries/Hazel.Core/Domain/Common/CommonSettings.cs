...
namespace Hazel.Core.Domain.Common
{
    ...
    public class CommonSettings : ISettings
    {
        ...
        /// <summary>
        /// Gets or sets the BreadcrumbDelimiter
        ...
        /// <summary>
        /// Gets or sets a value indicating whether we should support previous hazelCommerce versions (it can slightly improve performance).
        /// </summary>
        public bool SupportPreviousHazelcommerceVersions { get; set; }
        ...
        /// <summary>
        /// Gets or sets the StaticFilesCacheControl
        /// Gets or sets a value of "Cache-Control" header value for static content.
        /// </summary>
        public string StaticFilesCacheControl { get; set; }

        /// <summary>
        /// Gets or sets the FaviconAndAppIconsHeadCode
