...
namespace Hazel.Core.Domain.Common
{
    ...
    public class DisplayDefaultFooterItemSettings : ISettings
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to display "applicationUser info" footer item.
        /// </summary>
        public bool DisplayApplicationUserInfoFooterItem { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether to display "applicationUser orders" footer item.
        /// </summary>
        public bool DisplayApplicationUserOrdersFooterItem { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether to display "applicationUser addresses" footer item.
        /// </summary>
        public bool DisplayApplicationUserAddressesFooterItem { get; set; }
